...
var LeacloudSDK=function(){this.best_route=null;this.serverList=[];this.result=[];this.onAjax=!1;this.autoTesting=!0};
LeacloudSDK.prototype.init=function(a,b,c){a=void 0===a?[]:a;b=void 0===b?0:b;var e=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return e.serverList=a,e.onAjax=!0,0!=e.serverList.length&&e.autoTesting?d.yield(e.nodeTest(),3):d.jumpTo(2);2!=d.nextAddress&&null!=c&&c();e.onAjax=!1;return 0!=b&&e.autoTesting?d.yield(setTimeout(function(){return e.init(e.serverList,b,c)},6E4*b),0):d.jumpTo(0)})};
LeacloudSDK.prototype.nodeTest=function(){var a=this,b,c,e,d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:b=new FormData,c=[],e=0;case 2:if(!(e<a.serverList.length)){h.jumpTo(4);break}h.setCatchFinallyBlocks(5);d=(new Date).getTime();return h.yield(a.makeRequest("GET",a.serverList[e]),7);case 7:f=(new Date).getTime()-d;a.result.push([a.serverList[e],f,d]);c.push([a.serverList[e],f,d]);h.leaveTryBlock(3);break;case 5:g=h.enterCatchBlock(),console.log(g),
c.push([a.serverList[e],0,d]);case 3:e++;h.jumpTo(2);break;case 4:a.onAjax=!1,a.best_route=a.pick_best_route_so_far(),console.log(a.result),b.append("result",JSON.stringify(c)),console.log(b.get("result")),a.result=[],a.submitTestResult(b),h.jumpToEnd()}})};
LeacloudSDK.prototype.makeRequest=function(a,b,c){c=void 0===c?"":c;return new Promise(function(e,d){var f=new XMLHttpRequest;f.open(a,b);f.timeout=1E3;f.onload=function(){200==f.status?e(b):d({url:b,status:f.status,statusText:f.statusText})};f.onerror=function(){d({url:b,status:f.status,statusText:"error"})};f.ontimeout=function(){d({url:b,status:f.status,statusText:"timeout"})};""!=c?f.send(c):f.send()})};
LeacloudSDK.prototype.submitTestResult=function(a){this.makeRequest("POST","http://35.220.163.46:22000/sdk/receiver/",a)};LeacloudSDK.prototype.sleep=function(a){return new Promise(function(b){return setTimeout(b,a)})};LeacloudSDK.prototype.pick_best_route_so_far=function(a){a=void 0===a?this.result:a;a.sort(function(a,c){return a[1]<c[1]?-1:a[1]>c[1]?1:0});return a.map(function(a){return(new URL(a[0])).origin})};
LeacloudSDK.prototype.getBestRoute=function(a){return(void 0===a?0:a)?this.pick_best_route_so_far():null!=this.best_route?this.best_route:this.pick_best_route_so_far()};LeacloudSDK.prototype.delBestRoute=function(a){a=void 0===a?0:a;this.onAjax&&(0==a?this.best_route.shift():this.best_route.splice(a,1))};LeacloudSDK.prototype.setServerList=function(a){this.serverList=a=void 0===a?[]:a};LeacloudSDK.prototype.stopAutoTesting=function(){this.autoTesting=!1};
